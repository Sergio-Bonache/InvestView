  ...
  <nav class="bg-gray-200">
    <div class="container mx-auto flex items-center justify-between py-4 px-6">
      ...
      <div class="hidden lg:flex items-center justify-center flex-grow space-x-6">
        ...
        <RouterLink v-if="datosUsuario?.role != 'admin'" class="text-gray-700 hover:text-black-600" to="/miPortafolio">Mi Portafolio</RouterLink>
        <RouterLink v-if="datosUsuario?.role != 'admin'" class="text-gray-700 hover:text-black-600" to="/sobreNosotros">Calculadora de Interés Compuesto</RouterLink>
